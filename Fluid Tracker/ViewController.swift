...
class ViewController: UIViewController {
    ...
    func appMovedToForeground() {
        ...
        // If zero days, then nothing needs to happen
    ...
    // After several hours of messing with NSDate I somehow got it to work
    // If this were a more important project then I would have done this in a
    // much neater and more understandable way
...
extension ViewController: AddSubtractDelegate {
